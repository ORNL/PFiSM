 ...
 *
 ************************************************************************/
#ifndef included_CellPoissonFACOps
#define included_CellPoissonFACOps
 ...
 * -# The solution vector solv::SAMRAIVectorReal,
 ...
 * -# The source vector solv::SAMRAIVectorReal for f.
...
public:
   ...
   setPoissonSpecifications(
      const solv::PoissonSpecifications& spec)
   {
      d_poisson_spec = spec;
   }
    ...
    * solv::SAMRAIVectorReal::addComponent, you can use the
    * vector norm functions of solv::SAMRAIVectorReal, and
   ...
   void
   setPreconditioner(
      const solv::FACPreconditioner* preconditioner)
   {
...
private:
    ...
    */
   solv::PoissonSpecifications d_poisson_spec;
    ...
    */
   const solv::FACPreconditioner* d_preconditioner;
